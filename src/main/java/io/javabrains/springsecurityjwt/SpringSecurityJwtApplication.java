...
public class SpringSecurityJwtApplication {
	...
	CommandLineRunner run(UserService userService){
		return args -> {
			...
			userService.saveUser(new User("0916961458", "tuananh","vutuananh0405@gmail.com","pass",new HashSet<>()));
			userService.saveUser(new User("0916961458", "tuananh1","vutuananh04051@gmail.com","pass",new HashSet<>()));
			userService.saveUser(new User("0916961458", "tuananh2","vutuananh04052@gmail.com","pass",new HashSet<>()));
